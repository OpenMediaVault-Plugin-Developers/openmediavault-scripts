...
if omv_config_exists "/config/services/scripts/servicelogrnanoetentionlength"; then
  omv_config_delete "/config/services/scripts/servicelogrnanoetentionlength"
fi
